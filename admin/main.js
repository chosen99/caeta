window.onload = function () {
    ...
    const dataScaleX = document.getElementById('dataScaleX');
    const dataScaleY = document.getElementById('dataScaleY');
    let imagen = "";
    const options = {
        //aspectRatio: 16 / 9,
        aspectRatio: 3 / 4,
                ...
                case 'getCroppedCanvas':
                    if (result) {
                        ...
                        if (!download.disabled) {
                            ...
                            imagen = result.toDataURL(uploadedImageType);
                            $('.preview-recorte').attr('src',imagen);
