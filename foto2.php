...
<div class="container-fluid text-center border">
    <div class="m-auto rayas" style="border: 1px dashed red;">
        <div class="pt-2">
            <img id="img_user_" src="./recursos/img/svg/user2.svg" style="position:relative;">
        </div>
        <!--<div class="col-lg-3 col-3" style="border: 1px dashed red; z-index: 2"></div>
        <div class="col-lg-3 col-3" style="border: 1px dashed red; z-index: 2"></div>
        <div class="col-lg-3 col-3" style="border: 1px dashed red; z-index: 2"></div>
        <div class="col-lg-3 col-3" style="border: 1px dashed red; z-index: 2"></div>

        <div class="col-lg-3 col-3" style="border: 1px dashed red; z-index: 2"></div>
        <div class="col-lg-3 col-3" style="border: 1px dashed red; z-index: 2">p3</div>
        <div class="col-lg-3 col-3" style="border: 1px dashed red; z-index: 2">p4</div>
        <div class="col-lg-3 col-3" style="border: 1px dashed red; z-index: 2"></div>

        <div class="col-lg-3 col-3" style="border: 1px dashed red; z-index: 2"></div>
        <div class="col-lg-3 col-3" style="border: 1px dashed red; z-index: 2">p5</div>
        <div class="col-lg-3 col-3" style="border: 1px dashed red; z-index: 2">p6</div>
        <div class="col-lg-3 col-3" style="border: 1px dashed red; z-index: 2"></div>

        <div class="col-lg-3 col-3" style="border: 1px dashed red; z-index: 2"></div>
        <div class="col-lg-3 col-3" style="border: 1px dashed red; z-index: 2">p7</div>
        <div class="col-lg-3 col-3" style="border: 1px dashed red; z-index: 2">p8</div>
        <div class="col-lg-3 col-3" style="border: 1px dashed red; z-index: 2"></div> -->
...
<script>
    ...
    play.onclick = () => {
        ...
        const v = $("#video");
        $(".rayas").css({"width":v.width(), "height":v.height()});
        $("#img_user_").css({"height":v.height()-20});
    };
